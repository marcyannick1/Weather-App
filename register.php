                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="register space-y-4 md:space-y-6" action="" method="POST">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php if (isset($name)) {echo $name;} ?>" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe" required>
                        </div>
                        <div>
                        ...
                        <?php endif ?>
                        <button type="submit" name="register" class="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">S'inscrire</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Vous avez déja un compte? <a href="login.php" class="font-medium text-blue-600 hover:underline dark:text-primary-500">Connexion</a>
                        </p>
                    </form>
                </div>
            </div>
