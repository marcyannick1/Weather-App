                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            <a href="password_forgot.php" class="text-sm font-medium text-blue-500 hover:underline">Mot de passe oublié?</a>
                        </div>
                        <?php if (isset($error)) : ?>
                        ...
                        <?php endif ?>
                        <button type="submit" name="login" class="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Se connecter</button>
                        <p class="text-sm font-light text-gray-500">
                            Vous n'avez pas de compte? <a href="register.php" class="font-medium text-blue-600 hover:underline">Inscription</a>
