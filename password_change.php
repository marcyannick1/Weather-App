            ...
            <div class="w-full bg-white rounded-lg shadow">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="register space-y-4 md:space-y-6" action="" method="POST">
                        ...
                        <button type="submit" name="password-change" class="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Modifier mon mot de passe</button>
                    </form>
                </div>
            </div>
            <?php
